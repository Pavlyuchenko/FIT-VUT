class Main : Object {
    ...
    compute:and:and: "<- definice metody - selektor se třemi parametry"
        [ :x :y :z |
            ...
            _ := self vysl: a.
            "zpráva 'vysl' se zašle sobě , výsledkem je ref. na objekt vysl; tomuto objektu se pak zašle zpráva 'greaterThan:' s arg. 0."
            _ := ((self vysl) greaterThan: 0)
            "výsledkem je objekt typu True nebo False , kterému se zašle zpráva 'ifTrue:ifFalse:', argumenty jsou bezparametrické bloky"
